...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "NYC Activity Planner" },
      ...
      { name: "apple-mobile-web-app-title", content: "NYC Planner" },
    ],
    links: [
      {
        rel: "stylesheet",
